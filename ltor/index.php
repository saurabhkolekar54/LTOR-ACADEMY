...
<body class="fixed-navbar-padding">
    ...
    <section class="about-us" id="about-us">
        <div class="container">
            <div class="text">
                <h2>About Us</h2>
                <p>Welcome to LTOR Education, a leading professional training institute in Pune since 2011. We are dedicated to providing high-quality education and skill development opportunities to our students.</p>
                <p>At LTOR, we offer a range of courses, including Spoken English, Public Speaking, Study Skills, Business Skill Development, and Soft Skills Training. Our experienced instructors and comprehensive curriculum ensure that our students acquire the knowledge and skills needed to excel in their chosen fields.</p>
                <p>Our commitment extends beyond the classroom. We actively engage in various business activities, such as training, placement, marketing, business meet-ups, exhibitions, and seminars. Additionally, we offer franchise opportunities for those interested in partnering with us to spread quality education.</p>
        ...
        <div class="container">
            ...
            <div class="additional-info">
                <div class="info-item">
                    ...
                    <p>2nd Floor, Madhav Heritage, Lokmanya Bal Gangadhar Tilak Rd,Sadashiv Peth, Pune, Maharashtra 411030</p>
                </div>
                <div class="info-item">
            ...
            <!-- Google Map Embed (Replace 'YOUR_API_KEY' with your actual API key) -->
