...
if (isset($_POST['submit'])) {
    ...
    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "sisiisi", $courseName, $courseMembers, $courseDuration, $courseMode, $syllabusFileName, $imageFileName, $courseId);
            ...
            <div class="container">
                ...
                <form class="mt-4" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <!-- Course Image -->
                                <div class="form-group col-md-6">
                                    <label for="currentCourseImage">Current Course Image:</label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="courseMode" name="courseMode"
                                        value="<?php echo $mode; ?>" required>
